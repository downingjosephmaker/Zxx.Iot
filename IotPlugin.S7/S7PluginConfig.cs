...
namespace IotPlugin.S7
{
    ...
    public class S7PluginConfig : Config<S7PluginConfig>
    {
        ...
        [ConfigParameter("类型编码→CPU型号映射", "格式\"类型编码:型号\"逗号分隔,型号取S7200Smart/S7300/S7400/S71200/S71500;未配置默认S71200", false)]
        ...
        /// </summary>
        [DisplayName("槽号")]
        [ConfigParameter("槽号", "300/400常用2,1200/1500常用0或1,默认0", false)]
        ...
        [ConfigParameter("默认采集周期(毫秒)", "", false)]
        ...
        [ConfigParameter("单批次最大字节数", "按地址连续性合包上限,S7 PDU常见240字节", false)]
        ...
        [ConfigParameter("合包空洞容忍字节数", "0=禁止跨洞", false)]

...
namespace IotModel
{
    ...
    /// 控制|策略次数月表
    ///</summary>
    [DisplayName("控制|策略次数月表")]
    [SugarTable(TableName = "event_control_count_month", TableDescription = "控制|策略次数月表", IsDisabledUpdateAll = true)]
    public class EventControlCountMonth : EventBase
    {
        /// <summary>
        /// 雪花主键
        ///</summary>

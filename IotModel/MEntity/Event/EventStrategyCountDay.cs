...
namespace IotModel
{
    ...
    /// 策略模型次数日表
    ///</summary>
    [DisplayName("策略模型次数日表")]
    [SplitTable(SplitType.Month, typeof(SnowSplitService))]
    [SugarTable(TableName = "event_strategy_count_day", TableDescription = "策略模型次数日表", IsDisabledUpdateAll = true)]
    public class EventStrategyCountDay : EventBase
    {
        /// <summary>
        /// 雪花主键
        ///</summary>

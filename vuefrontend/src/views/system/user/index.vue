      ...
      >
        ...
        <template v-slot="{ size, dynamicColumns }">
          ...
          >
            <template #enable="{ row }">
              <el-popconfirm
                :title="`确定${row.IsEnable === 1 ? '禁用' : '启用'}账号【${row.UserUid}】吗？`"
                width="220"
                @confirm="handleToggleEnable(row)"
              >
                <template #reference>
                  <el-switch
            ...
            <template #operation="{ row }">
              ...
              <el-popconfirm
                :title="`确定将账号【${row.UserUid}】的密码重置为初始密码吗？`"
                width="240"

...
import { useStrategy } from "./utils/hook";
...
const {
  ...
  onbatchDel,
  onSelectionCancel
} = useStrategy(tableRef);
</script>

<template>
  <div class="main">
    <div class="flex-1">
      <el-tabs v-model="activeTab" class="strategy-tabs" @tab-change="onTabChange">
      ...
      >
        <el-form-item label="挂靠对象" prop="keyword">
          <el-input
            v-model="searchForm.keyword"
            placeholder="设备类型编码或设备ID"
            clearable
            class="!w-[180px]"
          />
        </el-form-item>
